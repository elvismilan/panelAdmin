        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Nuevo grupo</h5><span>Agregar registro</span>
                </div>
                <div class="card-body">
                    <?php
                    ...
                    <form method="post" action="/grupos/guardar" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="gru_id" class="form-label">ID de grupo <span class="text-danger">*</span></label>
                                <input id="gru_id"
                                       class="form-control"
                                       type="text"
                                       name="gru_id"
                                ...
                                <div class="form-text">Identificador unico del grupo. No puede modificarse despues.</div>
                            </div>
...
<script>
(function () {
    // Seleccionar / deseleccionar todos global
    ...
    // Todos / Ninguno por grupo (card padre)
