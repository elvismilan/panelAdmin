var colorHref = $("#color").attr("href") || "";
var colorBasePath = colorHref.replace(/color-\d+\.css(?:\?.*)?$/i, "");
function buildColorHref(colorName) {
    if (colorBasePath) return colorBasePath + colorName + ".css";
    return "../assets/css/" + colorName + ".css";
}
if(localStorage.getItem("color"))
    $("#color" ).attr("href", buildColorHref(localStorage.getItem("color")) );
