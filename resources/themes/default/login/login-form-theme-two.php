<?php
$headerFile = dirname(__DIR__) . '/header-two.php';
$footerFile = dirname(__DIR__) . '/footer-two.php';
...
<!--begin::Main-->
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(<?= htmlspecialchars($assetBase, ENT_QUOTES, 'UTF-8') ?>/media/bg/bg-1.jpg);">
